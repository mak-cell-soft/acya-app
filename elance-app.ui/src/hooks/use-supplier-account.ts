...
export function useSupplierStatement(id: number, startDate: Date, endDate: Date, enabled: boolean = true) {
  return useQuery<AccountStatement>({
    queryKey: ['supplier-statement', id, startDate.toISOString(), endDate.toISOString()],
