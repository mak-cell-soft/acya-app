...
function EditInvoicePageContent() {
  ...
  return (
    <DocumentFormShell
      ...
      subtitle="Modification d'une facture client directe — timbre fiscal, retenue à la source et montants."
    ...
    <Suspense fallback={
      <div className="flex items-center justify-center min-h-screen bg-sand-50/50">
        <div className="text-center space-y-4">
          ...
          <p className="text-xs text-sand-400 font-bold tracking-widest uppercase">Chargement de la facture...</p>
        </div>
      </div>
    }>
