                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input 
                      ...
                      className="h-11 rounded-xl border-forest-100 bg-background font-semibold text-forest-900"
                    />
                  </div>
                </div>
              ...
              <tbody className="divide-y divide-forest-50">
                {isLoading ? (
                  ...
                  advances.map((advance: Advance) => {
                    ...
                    return (
                      <tr key={advance.id} className="group hover:bg-forest-50/20 transition-all duration-300">
                        ...
                        <td className="p-4 w-60">
                          {advance.status !== 'Pending' && advance.status !== 'Rejected' ? (
                            <div className="space-y-1.5 px-4">
                              ...
                              <Progress value={pctRepaid} className="h-2 rounded-full bg-forest-50 [&>div]:bg-emerald-600" />
                            </div>
                          ) : (
                                ...
                                {activeRepayId === advance.id ? (
                                  <div className="flex items-center gap-1.5 animate-in fade-in zoom-in duration-300">
                                    <Input 
                                      ...
                                      className="h-8 w-20 px-2 rounded-lg font-bold border-forest-100 text-xs font-mono"
                                    />
                                    <Button 
                                      size="icon"
