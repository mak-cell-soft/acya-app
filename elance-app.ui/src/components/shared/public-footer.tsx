        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 pb-16 border-b border-slate-100">
          ...
          <div className="text-left">
            ...
            <div className="flex flex-col gap-2 mt-6 pt-4 border-t border-slate-100">
              <a href="mailto:acya.consulting@gmail.com" className="text-[0.85rem] text-slate-500 hover:text-corp-blue-600 transition-colors font-semibold flex items-center gap-2">
                <Mail className="w-4 h-4 shrink-0" /> <span className="truncate">acya.consulting@gmail.com</span>
              </a>
