...
/**
 * Return CSS print styles for Stock Purchase Cost & Valuation Reports (Multi-page A4).
 */
export function getStockPurchaseCostPrintStyles(): string {
  return `
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&family=Outfit:wght@500;700;800&display=swap');
    ...
    * {
    ...
    .print-container.cost-print-page {
      width: 100%;
      max-width: 194mm;
      margin: 0 auto;
      background: #fff !important;
    ...
    .kpi-card.highlight-cmp {
      border-color: #f59e0b;
      background: #fffbeb;
    }

    .kpi-card.highlight-last {
      border-color: #3b82f6;
      background: #eff6ff;
    }

    .kpi-card.highlight-variance {
      border-color: #10b981;
      background: #ecfdf5;
    }
    ...
    .col-cmp-pu, .col-last-pu {
      text-align: right !important;
      color: #334155;
    }

    .col-cmp-val, .col-last-val {
      text-align: right !important;
    }
...
/**
 * Return CSS print styles for Customer Reports and Customer Lists (A4 multi-page).
 * Optimized for multi-page tables, clear typographic hierarchy, and Tunisian corporate styling.
 */
export function getCustomerReportPrintStyles(): string {
  return `
    ...
    * {
    ...
    .report-table tbody tr.row-avoir {
