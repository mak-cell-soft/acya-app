    ...
    <div className="space-y-4">
      <div className="flex justify-end">
        <Button 
          ...
          size="sm"
          className="rounded-xl bg-corp-blue-600 text-white font-bold h-9 px-4 gap-2 hover:bg-corp-blue-800 transition-all shadow-lg shadow-corp-blue-600/10"
        >
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-corp-blue-50/50 hover:bg-corp-blue-50/50 border-corp-blue-50">
              <TableHead className="text-corp-blue-900 font-bold">Nom</TableHead>
              <TableHead className="text-corp-blue-900 font-bold">Valeur</TableHead>
              <TableHead className="text-corp-blue-900 font-bold text-center">Actif</TableHead>
              <TableHead className="text-corp-blue-900 font-bold text-center">Défaut</TableHead>
              ...
              <TableRow key={v.id} className="hover:bg-white transition-colors border-corp-blue-50">
                ...
                <TableCell className="font-medium text-corp-blue-900">
                  {editingId === v.id ? (
                    ...
                    <span className="font-bold text-corp-blue-600">
                      {(() => {
