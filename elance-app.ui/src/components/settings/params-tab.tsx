  ...
  return (
    <div className="space-y-10">
      <Tabs defaultValue="taxes" className="w-full">
        <TabsList className="bg-sand-50/50 p-1 rounded-2xl border border-forest-50 mb-8 h-auto flex-wrap justify-start">
          <TabsTrigger value="taxes" className="rounded-xl px-6 py-2.5 data-[state=active]:bg-white data-[state=active]:text-forest-900 data-[state=active]:shadow-sm font-bold gap-2">
            <Percent className="w-4 h-4" /> Taxes & TVA
          </TabsTrigger>
          <TabsTrigger value="dimensions" className="rounded-xl px-6 py-2.5 data-[state=active]:bg-white data-[state=active]:text-forest-900 data-[state=active]:shadow-sm font-bold gap-2">
            <Ruler className="w-4 h-4" /> Dimensions
          </TabsTrigger>
          <TabsTrigger value="categories" className="rounded-xl px-6 py-2.5 data-[state=active]:bg-white data-[state=active]:text-forest-900 data-[state=active]:shadow-sm font-bold gap-2">
            <Tags className="w-4 h-4" /> Catégories
          </TabsTrigger>
          <TabsTrigger value="transporters" className="rounded-xl px-6 py-2.5 data-[state=active]:bg-white data-[state=active]:text-forest-900 data-[state=active]:shadow-sm font-bold gap-2">
            <Truck className="w-4 h-4" /> Transporteurs
          </TabsTrigger>
          <TabsTrigger value="banks" className="rounded-xl px-6 py-2.5 data-[state=active]:bg-white data-[state=active]:text-forest-900 data-[state=active]:shadow-sm font-bold gap-2">
        ...
        <TabsContent value="dimensions" className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h4 className="text-forest-900 font-bold">Épaisseurs & Largeurs (mm)</h4>
              <DimensionTable nature="Dimension" data={dimensions} />
            </div>
            <div className="space-y-4">
              <h4 className="text-forest-900 font-bold">Longueurs (cm)</h4>
