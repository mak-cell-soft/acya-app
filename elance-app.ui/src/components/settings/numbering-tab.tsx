          ...
          <CardContent className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2.5">
              <Label className="text-sm font-bold text-forest-900 flex items-center gap-2">
                <Calendar className="w-4 h-4 text-forest-400" /> Format de l'Année
              </Label>
              <Select 
                ...
                <div key={doc.id} className="space-y-2">
                  ...
                  <div className="relative group">
                    <Input 
                      ...
                      placeholder="PRÉFIXE"
                      className="h-11 rounded-xl bg-sand-50/50 border-forest-100 focus:bg-white focus:border-forest-600 transition-all font-bold tracking-widest pl-4"
                    />
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 text-[10px] font-bold text-forest-200 group-focus-within:text-forest-400">
