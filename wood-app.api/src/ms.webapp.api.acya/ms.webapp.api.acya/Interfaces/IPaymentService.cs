...
namespace ms.webapp.api.acya.api.Interfaces
{
    public interface IPaymentService
    {
        ...
        Task<IEnumerable<DashboardPaymentDto>> GetDashboardPaymentsAsync(DateTime date, int userId, string? documentSide = null, bool monthOnly = false, bool allSites = false);
